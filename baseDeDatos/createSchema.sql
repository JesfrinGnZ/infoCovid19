...
CREATE TABLE COMENTARIO_HITO(
  ...
  CONSTRAINT FK_COMENTARIOHITO1 FOREIGN KEY(idHito) REFERENCES HITO(idHito)
);
...
CREATE TABLE ME_GUSTA(
  ...
  correoUsuario VARCHAR(25) NOT NULL,
  tipo CHAR NOT NULL,
  CONSTRAINT PK_MEGUSTA PRIMARY KEY(idMeGusta),
  CONSTRAINT FK_MEGUSTA FOREIGN KEY(idHito) REFERENCES HITO(idHito)
);
