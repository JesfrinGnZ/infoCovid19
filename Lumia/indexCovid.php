    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#services">Informacion COVID19</a></li>
          <li><a href="#portfolio">Hitos</a></li>
          <li><a href="#contact">Contacto</a></li>
      <?php
      if($_SESSION['usuario']!=null){
        echo "<li><a href=\"#contact\">".$_SESSION['usuario']."</a></li>";
      }
       ?>
     </ul>
     </nav><!-- .nav-menu -->
      ...
      <?php
        if($_SESSION!=null){
          echo "<form action=\"indexCovid.php\" method=\"post\">
                  <input class=\"btn-get-started scrollto\" type=\"submit\" value=\"Cerrar Sesion\">
                </form>";
          session_destroy();
        }else{
